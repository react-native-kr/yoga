...
컨텐츠 Align은 cross-axis를 따라 아이템 라인이 배치되는 것을 정의한다. 이는 아이템들이 여러 라인으로
묶여있을 때만 효과가 있습니다. 

<!-- **FLEX START (DEFAULT)** Align wrapped lines to the start of the container's cross axis.<n> -->
  
**FLEX START (DEFAULT)** 아이템 라인을 container의 cross-axis 시작부분에 정렬시킨다.

<!-- **FLEX END** Align wrapped lines to the end of the container's cross axis. -->

**FLEX END** 아이템 라인을 container의 cross-axis 끝부분에 정렬시킨다.

<!-- **STRETCH** Stretch wrapped lines to match the `height` of the container's cross axis. -->

**STRETCH** container의 cross-axis 높이에 균등하게 아이템 라인을 정렬시킨다.

<!-- **CENTER** Align wrapped lines in the center of the container's cross axis. -->

**CENTER** container의 cross-axis 중앙에 아이템 라인을 정렬시킨다.

<!-- **SPACE BETWEEN** Evenly space wrapped lines across the container's main axis, distributing
remaining space between the lines. -->

**SPACE BETWEEN** container의 cross-axis 시작과 끝에 걸쳐 아이템 라인을 정렬시킨다.
...
**SPACE AROUND** container의 cross-axis 시작부터 끝에 걸쳐 균등하게 나뉜 공간에 아이템 라인을 정렬시킨다. 
'SPACE BETWEEN'과 비교했을 때의 차이점이 있다면 아이템 라인 정렬이 시작하기 전과 끝난 후에도 공간이 분배된다는 점이다.
